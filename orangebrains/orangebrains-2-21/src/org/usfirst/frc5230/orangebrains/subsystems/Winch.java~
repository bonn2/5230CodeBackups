...
public class Winch extends Subsystem {
    ...
    private final SpeedController pullsin = RobotMap.winchpullsin;
    private final SpeedController releases = RobotMap.winchreleases;
    ...
    public void pullWinch () {
    	Robot.winch.pullsin.set(1);
	}
    public void releaseWinch (){
    	Robot.winch.releases.set(-1);
    }
