...
public class catapult extends Subsystem {
    ...
    private final DoubleSolenoid doubleSolenoid1 = RobotMap.catapultDoubleSolenoid1;
    private final DoubleSolenoid doubleSolenoid2 = RobotMap.catapultDoubleSolenoid2;
