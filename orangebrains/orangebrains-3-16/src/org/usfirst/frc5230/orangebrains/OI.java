...
public class OI {
    ...
    public OI() {
        ...
        buttonStick = new Joystick(1);//joystick
        driveStick = new Joystick(0);//xbox
        
        winchrelease = new JoystickButton(buttonStick, 11);
        winchrelease.whileHeld(new wrelease());
        
        winchin = new JoystickButton(buttonStick, 10);
        winchin.whileHeld(new wpull());
