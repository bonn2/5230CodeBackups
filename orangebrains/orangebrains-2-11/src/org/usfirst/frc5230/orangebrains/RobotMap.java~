...
public class RobotMap {
    ...
    public static SpeedController armliftupdownmotor;
    public static DoubleSolenoid armclimbL1sol;
    public static DoubleSolenoid armclimbL2sol;
    ...
    public static void init() {
        ...
        armliftupdownmotor = new Talon(5);
        LiveWindow.addActuator("arm lift", "up down motor", (Talon) armliftupdownmotor);
        
        armclimbL1sol = new DoubleSolenoid(0, 1, 2);
        LiveWindow.addActuator("arm climb", "L1sol", armclimbL1sol);
        
        armclimbL2sol = new DoubleSolenoid(0, 3, 4);
        LiveWindow.addActuator("arm climb", "L2sol", armclimbL2sol);
        
        intakewheelsliftmoving = new Talon(0);
