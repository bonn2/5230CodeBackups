    ...
    public void operatorControl() {
        ...
        while (isOperatorControl() && isEnabled()) {
            ...
            /*if (ButtonStick.getRawButton(10)){
             ...
             you know whats kinda sad? we will never get the opportunity to see if this beautiful code works because guess what? mech decided "nah we dont need to scale thsts not important"
             */
          ...
          CameraServer.getInstance().setImage(frame);           
           if(ButtonStick.getRawButton(3)) {
            	if(currentSession == frontSession) {
            		...
            		System.out.println("Nah son it ain't right.");
            	}
           }             
          }    
         }
